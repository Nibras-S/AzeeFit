...
//             // Calculate the new date and endDate
//             const newStartDate = new Date(contact.endDate).toISOString();  // Set date to current endDate
//             const newEndDate = new Date(contact.endDate);
//             newEndDate.setDate(newEndDate.getDate() + daysToAdd);
//             const newEndDateISO = newEndDate.toISOString();
